            ...
            {move || {
                ...
                Some(
                    izip!(
                        ...
                        {
                            let offset = FixedOffset::east_opt(forecast.utc_offset_seconds).unwrap();
                                    ...
                                    >
                                        ...
                                        <div class="flex gap-x-4 my-auto text-2xl font-bold">
                                            ...
                                            {move || match metric() {
                                                ...
                                                Metric::Wind => {
                                                    view! { cx, <Icon width="24" height="24" class="my-auto" icon=wind_direction_icon(winddirection)/> }
                                                }
                                            }}
                                        </div>
                                    </button>
